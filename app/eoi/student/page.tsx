...
const startPayment = async () => {
  ...
  try {
    ...
    const orderRes = await fetch("https://19b189314966.ngrok-free.app/olampiyad/paymentorder", {
      method: "POST",
      headers: {
    ...
    const options: any = {
      ...
      handler: async function (response: any) {
        ...
        try {
          ...
          const verifyRes = await fetch("https://19b189314966.ngrok-free.app/olampiyad/verify-payment", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
              "Authorization": token,
        ...
        <Card>
          <CardHeader>
            <CardDescription className="text-base font-medium text-black">
              ...
              <p className="mb-2"><strong> Kindly select your city of preference, the exam centres will be allocated accordingly.</strong></p>
          ...
          <CardContent>
            ...
            {studentForm.district && (
              <form onSubmit={handleSubmit} className="space-y-4 mt-4">
                ...
                <div className="space-y-2">
                  <Label>Contact Number <small className="text-[#B2252A]">(Your Hindustan Olympiad 2025 Roll. No. and Admit card will be shared here)</small></Label>
                  <Input value={studentForm.parentContact} onChange={(e) => setStudentForm((p) => ({ ...p, parentContact: e.target.value }))} />
                </div>
                {/* ✅ Email field with validation */}
                <div className="space-y-2">
                  <Label>Email Id <small className="text-[#B2252A]">(Your Hindustan Olympiad 2025 Roll. No. and Admit card will be shared here)</small></Label>
                  <Input
                    type="email"
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <Select
                    ...
                    onValueChange={(val) => {
                      setRegion(val);
                      // bhi studentForm me region set karo; saath me schoolDistrict reset kar do
                      setStudentForm(prev => ({ ...prev, region: val, schoolDistrict: "" }));
                    }}
                  >
                    <SelectTrigger>
