...
export default function SchoolDashboard() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    for (const [key, value] of Object.entries(formData)) {
      if (typeof value === "string" && value.trim() === "" && key !== "city") {
    ...
    // Region and District check (already exists but kept for consistency)
    ...
    const newSchool: School = {
      ...formData,
      district: [formData.district] as [string], // force tuple
      studentsCount: 0,
      paymentVerification: 0,
      addedBy: user?._id || "", // Add the required addedBy property
    };
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      {formData.region !== "" &&
                        districts[
                          formData.region as keyof typeof districts
