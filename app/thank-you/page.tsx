      ...
      <div className="max-w-2xl mx-auto text-center">
        <Card>
          <CardHeader className="p-6">
            <CardDescription>
              <h1 className="text-2xl font-bold mb-4 text-[#B2252A]">
                Thankyou for Registering in Hindustan Olympiad 2025
              </h1>
          ...
          <CardContent>
            <div className="text-center">
              <div className="max-w-xl text-gray-700 space-y-4">
                <p>
                  Your Admit card along with exam center details and all the instructions related to the exam will be shared on your registered email ID/ Phone No., 7 days prior to the exam date
                </p>
                <p>
